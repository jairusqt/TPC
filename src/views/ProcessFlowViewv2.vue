            ...
            <div class="modal-body">
              <div class="col-md-12 border rounded p-3 mx-auto row">
                ...
                <div class="col-md-2 p-1">
                    ...
                    <select @change="getItemCode(mainPartsNumber)" id="view_parts_number"  class="form-select" v-model="viewPartsNumber" disabled>
                        <option v-for="item in itemMaster" :value="item.item_parts_number">{{ item.item_parts_number }}</option>
                    </select>
                </div>
                <div class="col-md-2 p-1">
                ...
                <div class="col-md-2 p-1">
                    ...
                    <select @change="fetchKeyProcess" v-model="viewSection" class="form-select" id="view_section" disabled>
                        <option v-for="sec in section" :value="sec.section_id">{{sec.section_code}}</option>
                    </select>
                </div>
                <div class="col-md-2 p-1">
